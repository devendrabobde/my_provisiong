...
describe Admin::CaosController do
  ...
  describe "SA Test Cases" do

    it "As a logged in SA, I should be able to see form to create a new COA" do
      get :new, format: :html, organization_id: @organization.id
      response.should be_success
    end

    it "As a logged in SA, I should be able to edit a COA" do
    ...
    describe "Add new COA" do
      ...
      it "As a logged in SA, I should be able to create a new COA" do
        post :create, format: :html, organization_id: @organization.id, cao: @coa1_data
        response.status.should == 302
      end
      it "As a logged in SA, I should be able see error message while creating a new COA" do
        post :create, format: :html, organization_id: @organization.id, cao: @invalid_coa_data
        response.status.should == 200
      end
      it "As a logged in SA, I should be able to SA to add a second COA to an organization" do
    ...
    describe "Update COA" do
      ...
      it "As a logged in SA, I should be able to update details of a COA" do
        put :update, format: :html, id: @cao.id, organization_id: @organization.id, cao: @coa1_data
        response.status.should == 302
      end
      it "As a logged in SA, I should be able to see error message while updating details of a COA" do
        put :update, format: :html, id: @cao.id, organization_id: @organization.id, cao: @invalid_coa_data
        response.status.should == 200
      end
    end

    it "As a logged in SA, I should be able to select an organization" do
      post :index, format: :html, organization_id: @organization.id
      response.should be_success
    end

    it "As a logged in SA, I should be able to delete a COA" do
      delete :destroy, format: :html, id: @cao.id, organization_id: @organization.id, cao: { deleted_reason: "test" }
      response.status.should == 302
    end

    it "As a logged in SA, I should be able to view a COA" do
      get :show, format: :html, id: @cao.id, organization_id: @organization.id
      response.should be_success
    end

    it "As a logged in SA, I should be able to activate a COA" do
      post :activate, format: :html, id: @cao.id, organization_id: @organization.id
      response.status.should == 302
    end

    it "As a logged in SA, I should be able to view all COA in an organization" do
      post :index, format: :html, organization_id: @organization.id
      response.should be_success
    end
  end
