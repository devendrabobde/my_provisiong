...
describe Admin::OrganizationsController do
  ...
  describe "SA Test Cases" do
    ...
    it "As a logged in SA, I should be able to view organization" do
      get :show, format: :html, id: @organization.id
      response.should be_success
    end

    it "As a logged in SA, I should be able to view all organizations" do
      get :index, format: :html
      response.should be_success
    end

    it "As a logged in SA, I should be able to see form to create an organization" do
      get :new, format: :html
      response.should be_success
    end

    it "As a logged in SA, I should be able to edit an organization" do
    ...
    describe "Add new organization" do
      ...
      it "As a logged in SA, I should be able to add new organization" do
        post :create, format: :html, organization: @org_data
        response.status.should == 302
      end
      it "As a logged in SA, I should be able to see error message while creating an organization" do
    ...
    describe "Update organization" do
      ...
      it "As a logged in SA, I should be able to update organization" do
    ...
    it "As a logged in SA, I should be able to delete organization" do
      get :destroy, format: :html, id: @organization.id, organization: { deleted_reason: "test" }
      response.status.should == 302
    end

    it "As a logged in SA, I should be able to activate organization" do
      post :activate, format: :html, id: @organization.id
      response.status.should == 302
    end

    describe "Audits upload history" do
      it "As a logged in SA, I should be able to view any previously uploaded csv and its providers" do
