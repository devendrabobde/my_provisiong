Feature: Super Admin adds a new COA in an Existing Organization. Log in using this new COA and upload a valid csv file successfully
...
@selenium
@no-database-cleaner
Scenario: Super Admin add a new COA to existing organization
