  ...
  4. Strat redis server & then strat backgroud job queue, please refer below commands
    ...
    # Run multiple queue lists
      ...
      RAILS_ENV=development QUEUE=providers_queue,cached_updation rake environment resque:work


#
# Please are the steps to run rspec and cucumber test cases
#
...
4.Run resque queue in test environment below is the cmd for that,
...
1. For Cucumber 
  ...
  # To run specific feature
    => cucumber features/sa_organization_case.feature
